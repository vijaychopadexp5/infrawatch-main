...
if (isset($_POST['submit'])) {
    ...
    {
        return
            "<div> Hi you have a general enquiry $query_type from $name.
        <br>
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = "New Enquiry From Canaris";
        ...
        // $mail->send();
        // $mail->ClearAllRecipients();
        $alert = '<div><span> Your message has been sent. Thank you! </span></div>';
